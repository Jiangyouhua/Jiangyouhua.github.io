...
let WEB = {
    ...
    Source: function (selector) {
        ...
        if(WEB._isString(selector)){
            ...
            let attr = selector.getAttribute(DATA_SOURCE_TAG);
            if (!WEB._isString(attr)){
    ...
    Event: function(selector){
        ...
        if(WEB._isString(selector)){
            ...
            let attr = selector.getAttribute(DATA_AFFECT_TAG);
            if (!WEB._isString(attr)){
...
HTML.prototype = {
    ...
    SetTag: function (name) {
        if (typeof name != "string") {
            WEB.Out("HTML", "SetTag", "name", "string", name, 752);
            return;
        }
        this._tag = name.trim();
        return this;
    ...
    AddAttr: function (key, value) {
        if (typeof key != "string") {
            WEB.Out("HTML", "AddAttr", "key", "string", key, 856);
            return;
        }
